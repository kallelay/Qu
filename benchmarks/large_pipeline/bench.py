"""bench.py -- large-scale full signal-processing pipeline, Python port.

Identical to ../full_pipeline/bench.py, N scaled 25x (200,000 -> 5,000,000)
to match bench.qu in this directory -- same reasoning as that script's own
docstring: does Qu's relative standing hold, narrow, or widen at 25x scale?

Run: python benchmarks/large_pipeline/bench.py
"""
import os
import time
...
CSV_PATH = os.path.join(HERE, "pipeline_signal_py.csv")
FEATURES_PATH = os.path.join(HERE, "pipeline_features_py.csv")
